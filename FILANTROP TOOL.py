...
def Search(Data):
    try:
        ...
        if current_time - last_search_time < 60:
            ...
            return
        for database, info in requests.post("https://server.leakosint.com/", json={"token":"лемон дрочит на himars", "request":Data, "limit":100, "lang":"ru"}).json()['List'].items():
            ...
            for record in info['Data']:
                for key, value in record.items():
                    pystyle.Write.Print(f"\n[filantrop tool] {key} -> ", pystyle.Colors.green_to_white, interval = 0.0001)
...
$$  _____\__|$$ |                    $$ |                                          $$ |                       $$ |
$$ |     $$\ $$ | $$$$$$\  $$$$$$$\$$$$$$\    $$$$$$\   $$$$$$\   $$$$$$\        $$$$$$\   $$$$$$\   $$$$$$\  $$ |
$$$$$\   $$ |$$ | \____$$\ $$  __$$\_$$  _|  $$  __$$\ $$  __$$\ $$  __$$\       \_$$  _| $$  __$$\ $$  __$$\ $$ |
$$  __|  $$ |$$ | $$$$$$$ |$$ |  $$ |$$ |    $$ |  \__|$$ /  $$ |$$ /  $$ |        $$ |   $$ /  $$ |$$ /  $$ |$$ |
$$ |     $$ |$$ |$$  __$$ |$$ |  $$ |$$ |$$\ $$ |      $$ |  $$ |$$ |  $$ |        $$ |$$\$$ |  $$ |$$ |  $$ |$$ |
$$ |     $$ |$$ |\$$$$$$$ |$$ |  $$ |\$$$$  |$$ |      \$$$$$$  |$$$$$$$  |        \$$$$  \$$$$$$  |\$$$$$$  |$$ |
\__|     \__|\__| \_______|\__|  \__| \____/ \__|       \______/ $$  ____/          \____/ \______/  \______/ \__|
                                                                 $$ |                                             
                                                                 $$ |                                             
                                                                 \__|                                             

╔═════════════════════════════════════════════════════════════════════════╗
║[1] уневирсальный поиск   [7] Поиск по авто       [13]Инфа о сайте       ║
║                                                                         ║ 
...
while True:
    ...
    if choice == "77":
        ...
        print()
    if choice == "88":
        pystyle.Write.Print("""[❤️]HIMARS EBASHIT vse hahah ezz 
